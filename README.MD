# ngx-tree-dnd  [![npm version](https://badge.fury.io/js/ngx-tree-dnd.svg)](https://badge.fury.io/js/ngx-tree-dnd) [![npm monthly downloads](https://img.shields.io/npm/dm/ngx-tree-dnd.svg?style=flat-square)](https://www.npmjs.com/package/ngx-tree-dnd)

[![Dependency Status](https://david-dm.org/zicrael/ngx-tree-dnd.svg)](https://david-dm.org/akserg/ngx-tree-dnd)
[![devDependency Status](https://david-dm.org/zicrael/ngx-tree-dnd/dev-status.svg)](https://david-dm.org/akserg/ngx-tree-dnd#info=devDependencies)
## Installation
